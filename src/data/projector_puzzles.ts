...
export const projector_puzzles: { [key: string]: ProjectorPuzzle } = {
    "projectorpuzzle_dreamland_pergola_room": {
        ...
        startPoint: {
            id: "startPoint_x707_y1069_h134",
            nameSuffix: "Beam Emitter",
            position: { x: 706.8983545166831, y: 1069.9210824076897 },
            description: "Todo: insert a description for this projector puzzle beam point startPoint_x707_y1069_h134"
        },
        endPoint: {
            id: "endPoint_x735_y1098_h134",
    ...
    "projectorpuzzle_dreamland_windmill_hill": {
        name: "Dreamland Windmill Hill Puzzle",
        unlocks: [ "A door leading into the hill beneath the windmill" ],
        startPoint: {
            id: "startPoint_x468_y807_h180",
            nameSuffix: "Beam Emitter",
            position: { x: 467.8599818713551, y: 807.6942457753199 },
            description: "Todo: insert a description for this projector puzzle beam point startPoint_x468_y807_h180"
        },
        endPoint: {
            id: "endPoint_x432_y763_h186",
            nameSuffix: "Beam Receiver",
            position: { x: 431.97996605110825, y: 763.5542185444818 },
            description: "Todo: insert a description for this projector puzzle beam point endPoint_x432_y763_h186"
        }
    },
    "projectorpuzzle_hub_puzzle_tower": {
        name: "Hub Tower Puzzle",
        unlocks: [ "Todo: specify the unlocks of this radiant projector puzzle" ],
        startPoint: {
            id: "startPoint_x1018_y1539_h111",
            nameSuffix: "Beam Emitter",
            position: { x: 1017.6908829115532, y: 1539.5513956465152 },
            description: "Todo: describe this beam point. Also used for the terrarium entry puzzle, lowers upon completion."
        },
        endPoint: {
            id: "endPoint_x1036_y1535_h111",
            nameSuffix: "Beam Receiver",
            position: { x: 1035.0882000000001, y: 1535.90246 },
            description: "On the top floor of the puzzle tower. Upon completion, lowers the beam emitter to be used for the terrarium entry puzzle."
        }
    },
    "projectorpuzzle_terrarium_center_to_east": {
        name: "Terrarium Center To East Puzzle",
        unlocks: [ "Todo: specify the unlocks of this radiant projector puzzle" ],
        startPoint: {
            id: "startPoint_x793_y1969_h138",
            nameSuffix: "Beam Emitter",
            position: { x: 792.3884655015029, y: 1969.489368293332 },
            description: "Todo: insert a description for this projector puzzle beam point startPoint_x793_y1969_h138"
        },
        endPoint: {
            id: "endPoint_x793_y2147_h169",
            nameSuffix: "Beam Receiver",
            position: { x: 792.3784316195779, y: 2147.0903428276124 },
            description: "Todo: insert a description for this projector puzzle beam point endPoint_x793_y2147_h169"
        }
    },
    "projectorpuzzle_terrarium_east_to_center": {
        name: "Terrarium East To Center Puzzle",
        unlocks: [ "Todo: specify the unlocks of this radiant projector puzzle" ],
        startPoint: {
            id: "startPoint_x793_y2108_h196",
            nameSuffix: "Beam Emitter",
            position: { x: 792.1535169530589, y: 2108.565863673221 },
            description: "Todo: insert a description for this projector puzzle beam point startPoint_x793_y2108_h196"
        },
        endPoint: {
            id: "endPoint_x792_y1936_h178",
            nameSuffix: "Beam Receiver",
            position: { x: 791.658757950881, y: 1936.2289642997612 },
            description: "Todo: insert a description for this projector puzzle beam point endPoint_x792_y1936_h178"
        }
    },
    "projectorpuzzle_terrarium_entry": {
        name: "Terrarium Entry Puzzle",
        unlocks: [ "Todo: specify the unlocks of this radiant projector puzzle" ],
        startPoint: {
            id: "startPoint_x1018_y1539_h111",
            nameSuffix: "Beam Emitter",
            position: { x: 1017.6908829115532, y: 1539.5513956465152 },
            description: "Todo: describe this beam point. Also used for the puzzle on the tower's upper story, lowers upon completion."
        },
        endPoint: {
            id: "endPoint_x885_y1596_h37",
            nameSuffix: "Beam Receiver",
