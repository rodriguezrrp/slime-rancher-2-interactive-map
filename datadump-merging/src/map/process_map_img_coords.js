...
export async function extractCoordsOfMapImages() {
    ...
    return { partPositionsRI, partPositionsLabyrinth };

    .// TODO stitch images together based on offsetMin and offsetMax, and then gdal them

}

await extractCoordsOfMapImages();